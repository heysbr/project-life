  ...
  return (
    <div className="mb-10 ">
      ...
      <div className="grid grid-cols-3 gap-4 ">
        {currentData.map((staff, i) => <StaffCard staff={staff} i={i} key={i} />)}
      </div>
    ...
    >
      ...
      <div className="relative h-20 bg-pink-100 px-4 py-3 flex items-center justify-between">
        ...
        <div className="flex-1 mx-5">
          ...
          {/* Edit Menu */}
          {toggle && (
            <div className="absolute flex list-disc list-inside w-1/2 top-9 right-2 text-sm bg-white shadow-lg rounded-md p-4 z-10 transition-all duration-500"
            onClick={()=>setToggle(!toggle)}>
